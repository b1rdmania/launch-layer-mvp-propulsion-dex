    ...
    <div className="min-h-screen bg-launchlayer-background text-launchlayer-text-primary">
      ...
      <header className="bg-launchlayer-surface border-b border-launchlayer-surface-light p-4 sticky top-0 z-10">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-2 text-sm text-launchlayer-text-secondary">
            <FileText className="w-4 h-4" />
            <span>Chain-agnostic infrastructure</span>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto p-4 md:p-6 max-w-4xl">
        <div className="bg-launchlayer-surface rounded-xl border border-launchlayer-surface-light p-6 md:p-8 space-y-8">
          ...
          <div className="space-y-8">
            ...
            <section className="space-y-4">
              ...
              <p className="text-launchlayer-text-secondary leading-relaxed text-base">
              ...
              <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-accent">
                <h4 className="font-bold text-launchlayer-accent mb-2 flex items-center space-x-2 text-base">
                  <Database className="w-4 h-4" />
                  <span>Core Components:</span>
                </h4>
                <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary">
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-red-400">
                  <h4 className="font-bold text-red-400 mb-2 flex items-center space-x-2 text-base">
                    <Users className="w-4 h-4" />
                    <span>User-side:</span>
                  </h4>
                  <p className="text-sm md:text-base text-launchlayer-text-secondary">Risky presales, whitelist inefficiency, locked capital without yield.</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-accent">
                  <h4 className="font-bold text-launchlayer-accent mb-2 flex items-center space-x-2 text-base">
                  ...
                  <p className="text-sm md:text-base text-launchlayer-text-secondary">Complex fundraising mechanics, difficult liquidity provisioning.</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-mint">
                  <h4 className="font-bold text-launchlayer-mint mb-2 flex items-center space-x-2 text-base">
                    <Shield className="w-4 h-4" />
                    <span>Chain-side:</span>
                  </h4>
                  <p className="text-sm md:text-base text-launchlayer-text-secondary">No standardized turnkey infrastructure for retaining sustainable TVL and liquidity.</p>
                </div>
              </div>
              <p className="text-launchlayer-text-secondary text-base">
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <h5 className="font-bold text-launchlayer-text-primary mb-2 text-base">Mechanism Overview:</h5>
                  <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
                  ...
                  <h5 className="font-bold text-launchlayer-text-primary mb-2 mt-4 text-base">Yield Generation and Allocation Automation:</h5>
                  <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
                  ...
                  <h5 className="font-bold text-launchlayer-text-primary mb-2 mt-4 text-base">Technical Details:</h5>
                  <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <h5 className="font-bold text-launchlayer-text-primary mb-2 text-base">Curated & Permissionless Launch Paths:</h5>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h6 className="font-bold text-launchlayer-accent mb-1 text-base">Curated Launches:</h6>
                      <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
                    ...
                    <div>
                      <h6 className="font-bold text-launchlayer-mint mb-1 text-base">Permissionless Launches:</h6>
                      <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h6 className="font-bold text-launchlayer-mint mb-2 text-base">Initial Deployment: Algebra v4 AMM:</h6>
                      <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
                    ...
                    <div>
                      <h6 className="font-bold text-launchlayer-accent mb-2 text-base">Future Roadmap Upgrades:</h6>
                      <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-violet">
                  <h4 className="font-bold text-launchlayer-violet mb-2 text-base">Staking Yield:</h4>
                  <p className="text-sm md:text-base text-launchlayer-text-secondary">~10% protocol share from yield generated within Airlock vaults.</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-accent">
                  <h4 className="font-bold text-launchlayer-accent mb-2 text-base">Launchpad Fees:</h4>
                  <p className="text-sm md:text-base text-launchlayer-text-secondary">5% standard platform fee from project token raises.</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-mint">
                  <h4 className="font-bold text-launchlayer-mint mb-2 text-base">DEX Trading Revenue:</h4>
                  <p className="text-sm md:text-base text-launchlayer-text-secondary">Fixed protocol share from Propulsion Finance AMM trading volume (~0.05–0.15% per transaction).</p>
                </div>
              </div>
              <div className="bg-launchlayer-surface p-4 rounded-lg border border-launchlayer-accent/30">
                <h4 className="font-bold text-launchlayer-accent mb-2 text-base">Example Revenue Calculation (Single Cycle):</h4>
                <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary">
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-green-500">
                  <h4 className="font-bold text-green-500 mb-2 text-base">Current Status:</h4>
                  <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-accent">
                  <h4 className="font-bold text-launchlayer-accent mb-2 text-base">Q3-Q4 2025:</h4>
                  <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-mint">
                  <h4 className="font-bold text-launchlayer-mint mb-2 text-base">Q1-Q2 2026:</h4>
                  <ul className="space-y-1 text-sm md:text-base text-launchlayer-text-secondary list-disc list-inside">
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <h4 className="font-bold text-launchlayer-accent mb-3 flex items-center space-x-2 text-base">
                    <Users className="w-5 h-5" />
                    <span>Core Team:</span>
                  </h4>
                  <ul className="space-y-2 text-sm md:text-base text-launchlayer-text-secondary">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <h4 className="font-bold text-launchlayer-mint mb-3 flex items-center space-x-2 text-base">
            ...
            <section className="space-y-4">
              ...
              <div className="bg-launchlayer-surface p-6 rounded-lg border border-launchlayer-accent/30">
                <p className="text-launchlayer-text-secondary leading-relaxed mb-4 text-base">
            ...
            {/* Contact */}
            <section className="space-y-4 border-t border-launchlayer-surface-light pt-8">
              <div className="text-center bg-launchlayer-surface p-6 rounded-lg">
                <h3 className="text-lg md:text-xl font-bold text-launchlayer-accent mb-4 flex items-center justify-center space-x-2">
                  <Users className="w-5 h-5" />
                  <span>Contact for Deeper Technical Review</span>
                </h3>
                <div className="space-y-2 text-launchlayer-text-secondary text-base">
                ...
                <div className="mt-4 pt-4 border-t border-launchlayer-surface-light">
                  <p className="text-launchlayer-accent font-bold text-base">
