  ...
  return (
    <div className="min-h-screen bg-launchlayer-background text-launchlayer-text-primary">
      ...
      <main className="container mx-auto p-6 max-w-4xl">
        <div className="bg-launchlayer-surface rounded-xl border border-launchlayer-surface-light p-8 space-y-8">
          
          {/* Title Section */}
          <div className="text-center space-y-4 border-b border-launchlayer-surface-light pb-8">
            <div className="flex items-center justify-center space-x-3 mb-4">
              <Rocket className="w-10 h-10 text-launchlayer-accent" />
              <h1 className="text-4xl font-bold bg-gradient-to-r from-launchlayer-accent to-launchlayer-violet bg-clip-text text-transparent">
                Launch Layer
              </h1>
            </div>
            <h2 className="text-2xl font-bold text-launchlayer-text-primary">Technical White Paper</h2>
            <p className="text-lg text-launchlayer-accent font-medium">
          ...
          <div className="space-y-8">
            ...
            <section className="space-y-4">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-xl font-bold text-launchlayer-text-primary">Market Opportunity & Rationale</h3>
              </div>
              <p className="text-launchlayer-text-secondary leading-relaxed">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-red-400">
                  <h4 className="font-bold text-red-400 mb-2 flex items-center space-x-2">
                    <Users className="w-4 h-4" />
                    <span>User-side:</span>
                  </h4>
                  <p className="text-sm text-launchlayer-text-secondary">Risky presales, whitelist inefficiency, locked capital without yield.</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-accent">
                  <h4 className="font-bold text-launchlayer-accent mb-2 flex items-center space-x-2">
                  ...
                  <p className="text-sm text-launchlayer-text-secondary">Complex fundraising mechanics, difficult liquidity provisioning.</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-mint">
                  ...
                  <p className="text-sm text-launchlayer-text-secondary">No standardized turnkey infrastructure for retaining sustainable TVL and liquidity.</p>
                </div>
              </div>
            ...
            <section className="space-y-4">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-xl font-bold text-launchlayer-text-primary">Technical Architecture & Key Mechanisms</h3>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <h5 className="font-bold text-launchlayer-text-primary mb-2">Mechanism Overview:</h5>
                  <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
                  ...
                  <h5 className="font-bold text-launchlayer-text-primary mb-2 mt-4">Yield Generation and Allocation Automation:</h5>
                  <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
                  ...
                  <h5 className="font-bold text-launchlayer-text-primary mb-2 mt-4">Technical Details:</h5>
                  <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <h5 className="font-bold text-launchlayer-text-primary mb-2">Curated & Permissionless Launch Paths:</h5>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h6 className="font-bold text-launchlayer-accent mb-1">Curated Launches:</h6>
                      <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
                    ...
                    <div>
                      <h6 className="font-bold text-launchlayer-mint mb-1">Permissionless Launches:</h6>
                      <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <h6 className="font-bold text-launchlayer-mint mb-2">Initial Deployment: Algebra v4 AMM:</h6>
                      <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
                    ...
                    <div>
                      <h6 className="font-bold text-launchlayer-accent mb-2">Future Roadmap Upgrades:</h6>
                      <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
            ...
            <section className="space-y-4">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-xl font-bold text-launchlayer-text-primary">Economic Model & Revenue Streams</h3>
              </div>
              <p className="text-launchlayer-text-secondary">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-violet">
                  <h4 className="font-bold text-launchlayer-violet mb-2">Staking Yield:</h4>
                  <p className="text-sm text-launchlayer-text-secondary">~10% protocol share from yield generated within Airlock vaults.</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-accent">
                  <h4 className="font-bold text-launchlayer-accent mb-2">Launchpad Fees:</h4>
                  <p className="text-sm text-launchlayer-text-secondary">5% standard platform fee from project token raises.</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-mint">
                  <h4 className="font-bold text-launchlayer-mint mb-2">DEX Trading Revenue:</h4>
                  <p className="text-sm text-launchlayer-text-secondary">Fixed protocol share from Propulsion Finance AMM trading volume (~0.05–0.15% per transaction).</p>
                </div>
              </div>
              <div className="bg-launchlayer-surface p-4 rounded-lg border border-launchlayer-accent/30">
                <h4 className="font-bold text-launchlayer-accent mb-2">Example Revenue Calculation (Single Cycle):</h4>
                <ul className="space-y-1 text-sm text-launchlayer-text-secondary">
            ...
            <section className="space-y-4">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-xl font-bold text-launchlayer-text-primary">Roadmap & Deployment Plan</h3>
              </div>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-green-500">
                  <h4 className="font-bold text-green-500 mb-2">Current Status:</h4>
                  <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-accent">
                  <h4 className="font-bold text-launchlayer-accent mb-2">Q3-Q4 2025:</h4>
                  <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg border-l-4 border-l-launchlayer-mint">
                  <h4 className="font-bold text-launchlayer-mint mb-2">Q1-Q2 2026:</h4>
                  <ul className="space-y-1 text-sm text-launchlayer-text-secondary list-disc list-inside">
            ...
            <section className="space-y-4">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-xl font-bold text-launchlayer-text-primary">Team & Strategic Partnerships</h3>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <h4 className="font-bold text-launchlayer-accent mb-3 flex items-center space-x-2">
                ...
                <div className="bg-launchlayer-background p-4 rounded-lg">
                  <h4 className="font-bold text-launchlayer-mint mb-3 flex items-center space-x-2">
            ...
            <section className="space-y-4">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-xl font-bold text-launchlayer-text-primary">Conclusion & Investment Thesis</h3>
              </div>
              <div className="bg-launchlayer-surface p-6 rounded-lg border border-launchlayer-accent/30">
                <p className="text-launchlayer-text-secondary leading-relaxed mb-4">
            ...
            <section className="space-y-4 border-t border-launchlayer-surface-light pt-8">
              <div className="text-center bg-launchlayer-surface p-6 rounded-lg">
                ...
                <div className="space-y-2 text-launchlayer-text-secondary">
