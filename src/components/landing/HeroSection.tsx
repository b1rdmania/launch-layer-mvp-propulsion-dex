      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1280px] relative z-10">
        <div className="flex flex-col items-center gap-6 md:gap-8">
          <div className="w-full relative">
            <h1 className="text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 md:mb-6 tracking-tighter leading-tight font-satoshi relative">
              Launch on 
              ...
              {/* Floating Mascot - positioned right after "Sonic" text */}
              <div className="absolute top-0 left-[calc(100%+1rem)] hidden md:block">
                <div className="relative">
                  <img 
                    src="/lovable-uploads/27e46760-a877-4046-81f5-5a9cff92d823.png" 
                    alt="Launch Layer Mascot" 
                    className="w-16 h-16 lg:w-20 lg:h-20 animate-bounce drop-shadow-lg"
                    style={{
