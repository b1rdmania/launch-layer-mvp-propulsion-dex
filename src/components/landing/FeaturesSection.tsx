  ...
  return (
    <section className="py-16 bg-launchlayer-surface">
      <div className="container mx-auto px-8 max-w-[1280px]">
        <h2 className="text-3xl font-bold text-center mb-4 tracking-wider slide-in">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="slide-in" style={{transitionDelay: '100ms'}}>
            <FeatureCard
              icon={<Fingerprint size={32} className="text-[#56066E]" strokeWidth={1.5} />}
          ...
          <div className="slide-in" style={{transitionDelay: '200ms'}}>
            <FeatureCard
              icon={<LineChart size={32} className="text-[#17834]" strokeWidth={1.5} />}
          ...
          <div className="slide-in" style={{transitionDelay: '300ms'}}>
            <FeatureCard
              icon={<Terminal size={32} className="text-[#4a46]" strokeWidth={1.5} />}
          ...
          <div className="slide-in" style={{transitionDelay: '400ms'}}>
            <FeatureCard
              icon={<Settings size={32} className="text-[#60f7df]" strokeWidth={1.5} />}
          ...
          <div className="slide-in" style={{transitionDelay: '500ms'}}>
            <FeatureCard
              icon={<Workflow size={32} className="text-launchlayer-accent" strokeWidth={1.5} />}
          ...
          <div className="slide-in" style={{transitionDelay: '600ms'}}>
            <FeatureCard
              icon={<Shield size={32} className="text-launchlayer-mint" strokeWidth={1.5} />}
