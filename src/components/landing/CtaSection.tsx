...
const CtaSection: React.FC = () => {
  return (
    <section className="py-16 bg-gradient-to-br from-launchlayer-accent/20 to-launchlayer-secondary/20">
      <div className="container mx-auto px-8 max-w-[1280px] text-center">
        ...
        <Link to="/admin">
          <Button
            size="lg"
            className="bg-launchlayer-accent hover:bg-launchlayer-accent/90 text-white px-8 py-3 rounded-lg text-lg"
          >
            Start Your Raise
          </Button>
        </Link>
