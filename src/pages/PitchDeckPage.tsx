  ...
  const slides = [
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full text-center space-y-12 relative">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-20 left-20 w-32 h-32 bg-launchlayer-accent/10 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute bottom-20 right-20 w-40 h-40 bg-launchlayer-violet/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
            <div className="absolute top-1/2 right-1/3 w-24 h-24 bg-launchlayer-mint/10 rounded-full blur-2xl animate-pulse delay-2000"></div>
          </div>
          
          <div className="space-y-8 relative z-10">
            <div className="flex items-center justify-center space-x-4 mb-4">
              <Rocket className="w-12 h-12 text-launchlayer-accent" />
              ...
              <Rocket className="w-12 h-12 text-launchlayer-violet" />
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-launchlayer-text-primary flex items-center justify-center space-x-3">
              <Zap className="w-8 h-8 text-launchlayer-accent" />
          ...
          <div className="text-base text-launchlayer-text-secondary bg-launchlayer-surface/50 backdrop-blur-sm rounded-xl p-4 border border-launchlayer-surface-light">
      ...
      content: (
        <div className="space-y-6">
          <div className="text-center">
            <span className="px-6 py-3 rounded-full bg-launchlayer-violet/10 text-launchlayer-violet text-lg font-medium flex items-center justify-center space-x-2 w-fit mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-launchlayer-surface rounded-xl border-2 border-red-400/30 p-6 space-y-4">
              <h3 className="text-2xl font-bold text-red-400 border-b border-launchlayer-surface-light pb-3 flex items-center space-x-2">
              ...
              <ul className="space-y-3 text-sm text-launchlayer-text-secondary">
                ...
                <li className="flex items-start space-x-3">
                  <span className="text-red-400 mt-1 text-lg">⚠️</span>
            ...
            <div className="bg-launchlayer-surface rounded-xl border-2 border-launchlayer-mint/30 p-6 space-y-4">
              <h3 className="text-2xl font-bold text-launchlayer-mint border-b border-launchlayer-surface-light pb-3 flex items-center space-x-2">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-launchlayer-violet/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <Database className="w-3 h-3 text-launchlayer-violet" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-launchlayer-accent/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <Rocket className="w-3 h-3 text-launchlayer-accent" />
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-launchlayer-mint/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <Repeat className="w-3 h-3 text-launchlayer-mint" />
                  </div>
                  <div>
            ...
            {/* Market Chart */}
            <div className="bg-launchlayer-surface rounded-xl border border-launchlayer-surface-light p-6 space-y-4">
              <h3 className="text-xl font-bold text-launchlayer-accent border-b border-launchlayer-surface-light pb-3 flex items-center space-x-2">
      ...
      content: (
        <div className="space-y-6">
          <div className="text-center space-y-3">
            <span className="px-6 py-3 rounded-full bg-launchlayer-accent/10 text-launchlayer-accent text-lg font-medium flex items-center justify-center space-x-2 w-fit mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center space-y-4 p-6 bg-launchlayer-surface rounded-xl border-2 border-launchlayer-violet/30 relative">
              ...
              <div className="pt-4">
                <div className="w-16 h-16 bg-launchlayer-violet/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Database className="w-8 h-8 text-launchlayer-violet" />
                </div>
              ...
              <div className="hidden md:block absolute -right-3 top-1/2 transform -translate-y-1/2">
                <ArrowRight className="w-6 h-6 text-launchlayer-accent" />
              </div>
            </div>
            ...
            <div className="text-center space-y-4 p-6 bg-launchlayer-surface rounded-xl border-2 border-launchlayer-mint/30 relative">
              ...
              <div className="pt-4">
                <div className="w-16 h-16 bg-launchlayer-mint/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <TrendingUp className="w-8 h-8 text-launchlayer-mint" />
                </div>
              ...
              {/* Arrow to next step */}
              <div className="hidden md:block absolute -right-3 top-1/2 transform -translate-y-1/2">
                <ArrowRight className="w-6 h-6 text-launchlayer-mint" />
              </div>
            </div>
            ...
            <div className="text-center space-y-4 p-6 bg-launchlayer-surface rounded-xl border-2 border-launchlayer-accent/30 relative">
              ...
              <div className="pt-4">
                <div className="w-16 h-16 bg-launchlayer-accent/20 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div className="flex justify-center items-center space-x-4 pt-4">
            <div className="w-3 h-3 bg-launchlayer-violet rounded-full animate-pulse"></div>
            <div className="w-8 h-0.5 bg-gradient-to-r from-launchlayer-violet to-launchlayer-mint"></div>
            <div className="w-3 h-3 bg-launchlayer-mint rounded-full animate-pulse delay-500"></div>
            <div className="w-8 h-0.5 bg-gradient-to-r from-launchlayer-mint to-launchlayer-accent"></div>
            <div className="w-3 h-3 bg-launchlayer-accent rounded-full animate-pulse delay-1000"></div>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="text-center space-y-3">
            <span className="px-6 py-3 rounded-full bg-launchlayer-mint/10 text-launchlayer-mint text-lg font-medium flex items-center justify-center space-x-2 w-fit mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-launchlayer-surface p-4 rounded-xl border-t-4 border-t-launchlayer-violet space-y-2 relative overflow-hidden">
              <div className="absolute top-2 right-2">
                <Database className="w-8 h-8 text-launchlayer-violet/30" />
              </div>
              <h3 className="text-lg font-bold text-launchlayer-violet border-b border-launchlayer-surface-light pb-2 flex items-center space-x-2">
            ...
            <div className="bg-launchlayer-surface p-4 rounded-xl border-t-4 border-t-launchlayer-accent space-y-2 relative overflow-hidden">
              <div className="absolute top-2 right-2">
                <Rocket className="w-8 h-8 text-launchlayer-accent/30" />
              </div>
              <h3 className="text-lg font-bold text-launchlayer-accent border-b border-launchlayer-surface-light pb-2 flex items-center space-x-2">
            ...
            <div className="bg-launchlayer-surface p-4 rounded-xl border-t-4 border-t-launchlayer-mint space-y-2 relative overflow-hidden">
              <div className="absolute top-2 right-2">
                <Repeat className="w-8 h-8 text-launchlayer-mint/30" />
              </div>
              <h3 className="text-lg font-bold text-launchlayer-mint border-b border-launchlayer-surface-light pb-2 flex items-center space-x-2">
                <Repeat className="w-5 h-5" />
          ...
          <div className="text-center bg-launchlayer-surface p-3 rounded-xl border border-launchlayer-accent/30">
            <p className="text-base font-bold text-launchlayer-accent flex items-center justify-center space-x-2">
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-launchlayer-surface rounded-xl border border-launchlayer-surface-light p-4 space-y-3">
              <h3 className="text-xl font-bold text-launchlayer-accent border-b border-launchlayer-surface-light pb-2 flex items-center space-x-2">
                <Rocket className="w-5 h-5" />
                <span>🚀 Traction Today</span>
              </h3>
              <div className="space-y-2">
                <div className="flex items-start space-x-3 p-2 bg-launchlayer-background rounded-lg">
                  <Check className="text-green-400 mt-1 flex-shrink-0" size={14} />
            ...
            <div className="space-y-3">
              <div className="bg-launchlayer-surface rounded-xl border border-launchlayer-surface-light p-4 space-y-3">
                <h3 className="text-xl font-bold text-launchlayer-mint border-b border-launchlayer-surface-light pb-2 flex items-center space-x-2">
                ...
                <div className="bg-launchlayer-accent/10 p-3 rounded-xl border border-launchlayer-accent/30">
              ...
              {/* Revenue Chart */}
              <div className="bg-launchlayer-surface rounded-xl border border-launchlayer-surface-light p-4">
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-launchlayer-surface rounded-xl border border-launchlayer-surface-light p-6 space-y-5">
              <h3 className="text-2xl font-bold text-launchlayer-accent border-b border-launchlayer-surface-light pb-3 flex items-center space-x-2">
                <Users className="w-6 h-6" />
                <span>👥 Core Team</span>
              </h3>
              <div className="space-y-3">
                <div className="bg-launchlayer-background p-4 rounded-xl border-l-4 border-l-launchlayer-violet relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <Star className="w-6 h-6 text-launchlayer-violet/20" />
                  </div>
                  <h4 className="font-bold text-launchlayer-violet text-lg flex items-center space-x-2">
                    <span>🚀</span>
                    <span>Andy (Co-Founder)</span>
                  </h4>
                  <p className="text-launchlayer-text-secondary">Product & Strategy</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-xl border-l-4 border-l-launchlayer-accent relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <Star className="w-6 h-6 text-launchlayer-accent/20" />
                  </div>
                  <h4 className="font-bold text-launchlayer-accent text-lg flex items-center space-x-2">
                    <span>🤝</span>
                    <span>Stable (Co-Founder)</span>
                  </h4>
                  <p className="text-launchlayer-text-secondary">Business Development & Partnerships</p>
                </div>
                <div className="bg-launchlayer-background p-4 rounded-xl border-l-4 border-l-launchlayer-mint relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <Star className="w-6 h-6 text-launchlayer-mint/20" />
                  </div>
                  <h4 className="font-bold text-launchlayer-mint text-lg flex items-center space-x-2">
                    <span>⚡</span>
            ...
            <div className="bg-launchlayer-surface rounded-xl border border-launchlayer-surface-light p-6 space-y-5">
              ...
              <div className="space-y-3">
                <div className="bg-launchlayer-background p-4 rounded-xl border-l-4 border-l-launchlayer-violet relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <TrendingUp className="w-6 h-6 text-launchlayer-violet/20" />
                  </div>
                  <h4 className="font-bold text-launchlayer-violet text-lg flex items-center space-x-2">
                    <span>📈</span>
                ...
                <div className="bg-launchlayer-background p-4 rounded-xl border-l-4 border-l-launchlayer-accent relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <Shield className="w-6 h-6 text-launchlayer-accent/20" />
                  </div>
                  <h4 className="font-bold text-launchlayer-accent text-lg flex items-center space-x-2">
                    <span>⚖️</span>
                ...
                <div className="bg-launchlayer-background p-4 rounded-xl border-l-4 border-l-launchlayer-mint relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <Zap className="w-6 h-6 text-launchlayer-mint/20" />
                  </div>
                  <h4 className="font-bold text-launchlayer-mint text-lg flex items-center space-x-2">
                    <span>🎨</span>
          ...
          <div className="space-y-6">
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto">
                <div className="bg-launchlayer-surface p-4 rounded-xl border-l-4 border-l-launchlayer-violet relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <Database className="w-6 h-6 text-launchlayer-violet/20" />
                  </div>
                ...
                <div className="bg-launchlayer-surface p-4 rounded-xl border-l-4 border-l-launchlayer-accent relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <Rocket className="w-6 h-6 text-launchlayer-accent/20" />
                  </div>
                ...
                <div className="bg-launchlayer-surface p-4 rounded-xl border-l-4 border-l-launchlayer-mint relative overflow-hidden">
                  <div className="absolute top-2 right-2">
                    <Repeat className="w-6 h-6 text-launchlayer-mint/20" />
                  </div>
      ...
      <header className="bg-launchlayer-surface border-b border-launchlayer-surface-light p-4">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="text-sm text-launchlayer-text-secondary flex items-center space-x-2">
              <BarChart3 className="w-4 h-4" />
